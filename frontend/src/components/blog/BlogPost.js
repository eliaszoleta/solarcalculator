...
function SidebarCTA() {
  return (
    <div className="sidebar-cta">
      <div className="sidebar-cta__icon">☀️</div>
      ...
      <div className="post-layout">
        ...
        <main>
          ...
          <div className="post-cta-inline">
            <div className="post-cta-inline__icon" aria-hidden>☀️</div>
            ...
            >
              ...
              {idx === Math.floor(post.sections.length / 2) - 1 && (
                <div className="post-cta-inline" style={{ marginTop: 24 }}>
                  <div className="post-cta-inline__icon" aria-hidden>🔢</div>
                  <div className="post-cta-inline__text">
          ...
          <div className="post-cta-block">
            <div className="post-cta-block__icon" aria-hidden>☀️</div>
