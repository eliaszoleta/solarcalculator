...
<script>
(function(){var o=null;window.addEventListener('message',function(e){if(!e.data||e.data.type!=='MSW_OPEN_REPORT'||o)return;o=document.createElement('div');o.style.cssText='position:fixed;inset:0;z-index:2147483647;background:rgba(15,23,42,0.7);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);display:flex;align-items:center;justify-content:center;padding:16px;box-sizing:border-box;animation:mswFadeIn 0.2s ease;';var m=document.createElement('div');m.style.cssText='background:#f8fafc;width:100%;max-width:680px;height:92vh;border-radius:20px;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 32px 80px rgba(0,0,0,0.45);';var h=document.createElement('div');h.style.cssText='padding:14px 20px;border-bottom:1px solid #e2e8f0;display:flex;align-items:center;justify-content:space-between;flex-shrink:0;background:white;border-radius:20px 20px 0 0;';var tl=document.createElement('div');tl.innerHTML='<span style="font-weight:800;font-size:15px;font-family:system-ui,sans-serif;color:#0f172a;">Full Solar Report</span>';var cb=document.createElement('button');cb.style.cssText='display:flex;align-items:center;gap:5px;font-size:13px;color:#64748b;font-weight:600;background:#f1f5f9;border:1px solid #e2e8f0;border-radius:8px;cursor:pointer;padding:6px 12px;font-family:inherit;transition:background 0.15s;';cb.innerHTML='\u2715 Close';cb.onmouseover=function(){cb.style.background=\'#e2e8f0\';};cb.onmouseout=function(){cb.style.background=\'#f1f5f9\';};cb.onclick=cl;h.appendChild(tl);h.appendChild(cb);var fr=document.createElement('iframe');fr.src=e.data.url;fr.style.cssText='flex:1;border:none;width:100%;background:#f8fafc;';fr.scrolling=\'yes\';m.appendChild(h);m.appendChild(fr);o.appendChild(m);o.onclick=function(ev){if(ev.target===o)cl();};var st=document.createElement('style');st.textContent=\'@keyframes mswFadeIn{from{opacity:0;transform:scale(0.97)}to{opacity:1;transform:scale(1)}}\';document.head.appendChild(st);document.body.appendChild(o);document.body.style.overflow=\'hidden\';function cl(){if(o&&o.parentNode)o.parentNode.removeChild(o);document.body.style.overflow=\'\';o=null;}});})();
<\/script>`;
